...
public class FloatingObject : MonoBehaviour
{
    ...
    [SerializeField] private float underWaterAngularDrap;
    [SerializeField] private float airDrag;
    [SerializeField] private float airAngularDrap;
    ...
    private void SetStage(bool underWater)
    {
        if (underWater)
        {
            ...
            _rb.angularDrag = underWaterAngularDrap;
        }
        else
        {
            _rb.drag = airDrag;
            _rb.angularDrag= airAngularDrap;
        }
    }
}
